...
public class GradebookControllerTest {
    ...
    public void getStudentsHttpRequest() throws Exception{
        ...
        CollegeStudent studentOne = new GradebookCollegeStudent("Eric", "Roby", "eric_brody@luv2code_school.com");
    ...
    public void createStudentHttpRequest() throws Exception{
        ...
        CollegeStudent studentOne = new CollegeStudent("Eric", "Roby", "eric_roby@luve2code_school.com");
    ...
    @Test
    public void studentInformationHttpReuqest() throws Exception{
    ...
    public void createValidGradeHttpRequest() throws Exception {
        ...
        MvcResult mvcResult= this.mockMvc.perform(post("/grades").contentType(MediaType.APPLICATION_JSON).param("grade", "85.00")
                .param("gradeType", "math").param("studentId", "1")).andExpect(status().isOk()).andReturn();
    ...
    public void createAValidGradeHttpRequestStudentDoesNotExistEmptyResponse() throws Exception{
        ...
        MvcResult mvcResult = this.mockMvc.perform(post("/grades").contentType(MediaType.APPLICATION_JSON)
                .param("grade", "85.00").param("gradeType", "history").param("studentId", "0"))
    ...
    @Test
    public void createAnNonValidGradeHttpRequestGradeTypeDoesNotExistEmptyResponse() throws Exception{

        MvcResult mvcResult = this.mockMvc.perform(post("/grades").contentType(MediaType.APPLICATION_JSON)
                        .param("grade", "85.00").param("gradeType", "literature").param("studentId", "0"))
                .andExpect(status().isOk()).andReturn();
